...
#if IP_REASSEMBLY == 0 && IP_REASS_MAX_PBUFS >= (ENET_RXBUFF_NUM - ENET_RXBD_NUM)
#error \
...
#if IP_REASSEMBLY == 0 && \
    (CHECKSUM_CHECK_ICMP == 1 || CHECKSUM_CHECK_ICMP6 == 0 || CHECKSUM_CHECK_UDP == 0 || CHECKSUM_CHECK_TCP == 0)
#error \
...
#if IP_FRAG == 0 && \
    (CHECKSUM_GEN_ICMP == 1 || CHECKSUM_GEN_ICMP6 == 0 || CHECKSUM_GEN_UDP == 0 || CHECKSUM_GEN_TCP == 0)
#error \
